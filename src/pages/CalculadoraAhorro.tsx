...
function CalculadoraAhorro() {
    ...
    const calcularAhorro = () => {
        ...
        if (tasaInteresNum === 0) {
            ...
            const ahorroMensualCalculado = cantidadNecesaria / plazoNum;
            ...
            // Fórmula para calcular el ahorro mensual con interés compuesto
            const factor1 = Math.pow(1 + tasaMensual, plazoNum);
            const ahorroMensualCalculado = (metaNum - ahorroInicialNum * factor1) / ((factor1 - 1) / tasaMensual);

            // Calcular el total acumulado y el interés ganado
            const totalAportaciones = ahorroMensualCalculado * plazoNum + ahorroInicialNum;
            const interesGanadoCalculado = metaNum - totalAportaciones;

            setResultado({
                ahorroMensual: ahorroMensualCalculado,
                totalAcumulado: metaNum,
                interesGanado: interesGanadoCalculado
            });
        }
